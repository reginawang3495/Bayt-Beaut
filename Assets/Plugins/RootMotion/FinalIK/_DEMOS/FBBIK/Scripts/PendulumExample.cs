...
namespace RootMotion.Demos {
	...
	public class PendulumExample : MonoBehaviour {
		...
		public Transform targetConnectedBone; // TT-added this. was leftHandTarget
		...
		void Start() {
			...
			if (targetConnectedBone == null) {
				targetConnectedBone = leftHandTarget;
			}

			Quaternion targetRotation = target.rotation;
			target.rotation = targetConnectedBone.rotation;

			FixedJoint j = target.gameObject.AddComponent<FixedJoint>();
			j.connectedBody = targetConnectedBone.GetComponent<Rigidbody>();
